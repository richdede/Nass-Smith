    ...
    >
      <div className=" lg:p-6 p-5 ">
        ...
        <div>
          ...
          >
            I'm Nass Smith, a Frontend engineeer with over 2 years of
            experience, currently residing in Ilorin, Nigeria. I have a deep
        ...
        <div>
          ...
          <motion.p
            ...
            className="text-neutral-700 text-lg my-7 leading-8 font-InterRe dark:text-[#C0C0C0]"
          >
            Nass Smith holds a frontend degree in Frontend Engineering from a
            prestigious hub known as Malhub and has a relentless drive for
            staying up-to-date with the latest technologies and design trends.
            Actively involved in the community, and a lot more in Web3 spaces.
          </motion.p>
          ...
          <motion.p
            ...
            className="text-neutral-700 text-lg my-7 leading-8 font-InterRe dark:text-[#C0C0C0]"
          >
            When I'm not immersed in crafting projects work, he finds solace in
            playing the with the crypto world. I firmly believes in maintaining
            a healthy work-life balance, making sure to take breaks and
            reenergize his creativity. In my spare time, i also like to engage
          ...
          <div className="bg-[#F6F8FA] dark:bg-[#2C2C2C] p-6  mt-4 rounded-md">
            <div className="text-center">
              <span className="text-neutral-700 dark:text-neutral-400">
                © 2024 2024 Nass Smith – All Right Reserved
              </span>
